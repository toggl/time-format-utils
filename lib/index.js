...
(function() {
  ...
  exports.secondsToExtHhmmss = function(t, type) {
    if (type === 'improved') {
      return exports.secToHhmmImproved(t);
  ...
  exports.secToHhmmImproved = function(seconds) {
    ...
    return "<span class='duration'>" + formatted + "</span>";
  };
